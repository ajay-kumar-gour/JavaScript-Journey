...
|----------------|-------------|---------------------------|---------------------------------------------------------|
| String         | Primitive   | "Hello"                   | Represents textual data.                                |
| Number         | Primitive   | 42, 3.14                  | Represents numeric values.                              |
| Boolean        | Primitive   | true, false               | Represents true or false values.                        |
| Undefined      | Primitive   | undefined                | Represents the absence of a value.                      |
| Null           | Primitive   | null                      | Represents the absence of any object value.             |
| Symbol         | Primitive   | Symbol("unique")          | Represents a unique identifier.                         |
| Object         | Reference   | { key: "value" }          | Represents a collection of key-value pairs.             |
